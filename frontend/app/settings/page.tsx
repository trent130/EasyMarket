        ...
        <div className="px-4 py-6 sm:px-0">
          ...
          <div className="bg-white shadow rounded-lg">
            ...
            <div className="p-6">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      >
                        <span className={`
                          ...
                          ease-in-out duration-200 ${settings.darkMode ? 'translate-x-5' : 'translate-x-0'}
                        `} />
                      </button>
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      >
                        <span className={`
                          pointer-events-none inline-block h-5 w-5 rounded-full bg-white shadow transform ring-0 transition 
                          ease-in-out duration-200 ${settings.maintenanceMode ? 'translate-x-5' : 'translate-x-0'}
                        `} />
                      </button>
                    </div>
                  </div>
              ...
              {activeTab === 'notifications' && (
                <div className="space-y-6">
                  <div className="flex items-center justify-between">
                    ...
                    <button aria-label='pushnotifications'
                      type="button"
                    ...
                    >
                      <span className={`
                        pointer-events-none inline-block h-5 w-5 rounded-full bg-white shadow transform ring-0 transition 
                        ease-in-out duration-200 ${settings.enableNotifications ? 'translate-x-5' : 'translate-x-0'}
                      `} />
                    </button>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    >
                      <span className={`
                        pointer-events-none inline-block h-5 w-5 rounded-full bg-white shadow transform ring-0 transition 
                        ease-in-out duration-200 ${settings.emailNotifications ? 'translate-x-5' : 'translate-x-0'}
                      `} />
                    </button>
                  </div>
                </div>
              ...
              {activeTab === 'payments' && (
                <div className="text-gray-500">Payment settings configuration options will appear here.</div>
              )}
              {activeTab === 'shipping' && (
                <div className="text-gray-500">Shipping settings configuration options will appear here.</div>
              )}
              {activeTab === 'emails' && (
                <div className="text-gray-500">Email template settings will appear here.</div>
              )}
              {activeTab === 'security' && (
                <div className="text-gray-500">Security and authentication settings will appear here.</div>
              )}
            </div>
          </div>
        </div>
